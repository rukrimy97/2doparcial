...
public class Login extends BaseWindow {
    ...
    private void createAnotherButton() {
    	this.button = new ButtonComponent(this.lang.getI18nText(TextCodes.ButtonTextPro), this.rightPanel);
    	this.button.setPosition(260);
    	this.rightPanel.add(this.button);
    	this.button.addActionListener(e ->{
    		//agrega las acciones del boton aqui
