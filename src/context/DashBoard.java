...
public class DashBoard extends BaseWindow {
    ...
    public DashBoard(Translations lang, String title) {
        ...
        navList.add("mi boton esquiasofrenico");
    ...
    public void createPanels() {
        ...
        middle.setSize(new Dimension(620, 670));
        middle.setLocation(330, 10);
        ...
        rightBox.setSize(new Dimension(260, 670));
        rightBox.setLocation(950, 10);
